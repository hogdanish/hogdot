...
| `web-template_{release,debug}.{threads,nothreads}.wasm32.zip` | Not built since r14. Both CommonGrounds web presets ship a GDExtension and select the dlink twins below, so nothing consumed these four. r1–r13 carry them. |
