...
| `web-template_{release,debug}.threads.dlink.wasm32.zip` | The two shipped web templates: the builds above plus `dlink_enabled=yes`, threaded only since r14. See "The dlink templates". The `.nothreads.dlink` pair is in r9–r13 only. |
